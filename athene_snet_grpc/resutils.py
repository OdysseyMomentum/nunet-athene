...
class resutils():
    ...
    def call_telemetry(self,cpu_used,memory_used,net_used,time_taken):
        ...
        subprocess.Popen(["grpcurl", "-plaintext", "-proto", "athene_grpc/service_spec/telemetry.proto", "-d",  str(params) , "195.201.197.25:50000" , "session_manager.SessionManager/telemetry"],stderr=subprocess.PIPE)
